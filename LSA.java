...
public class LSA {
    ...
    public LSA(double amount, double dwnPayment, int score, int term) {
        loanAmount = amount;
        creditScore = score;
        payTerm = term;
        downPayment = dwnPayment;
    }
    ...
    public static void main(String[] args){
        ...
        Scanner dPay = new Scanner(System.in);
        ...
        double downPay = dPay.nextDouble();
        ...
        LSA loanApp1 = new LSA(lAmount,downPay,creditS,payTm);
        loanApp1.loanApp();
    }
}
